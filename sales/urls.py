...
urlpatterns = [
    ...
    path("quotations/<int:pk>/print/", views.SalesQuotationPrintView.as_view(), name="quotation_print"),
    path("quotations/<int:pk>/pdf/", views.SalesQuotationPrintView.as_view(), name="quotation_pdf"),
    ...
    path("orders/<int:pk>/print/", views.SalesOrderPrintView.as_view(), name="order_print"),
    path("orders/<int:pk>/pdf/", views.SalesOrderPrintView.as_view(), name="order_pdf"),
    ...
    path("deliveries/<int:pk>/print/", views.DeliveryNotePrintView.as_view(), name="delivery_print"),
    path("deliveries/<int:pk>/pdf/", views.DeliveryNotePrintView.as_view(), name="delivery_pdf"),
    ...
    path("returns/<int:pk>/print/", views.SalesReturnPrintView.as_view(), name="return_print"),
    path("returns/<int:pk>/pdf/", views.SalesReturnPrintView.as_view(), name="return_pdf"),
